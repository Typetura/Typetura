...
return d.innerHTML="html{--tt-base: ".concat(b,";--tt-scale: ").concat(c,";--tt-ease:linear;--tt-max:1600}*,:before,:after,html{--tt-key:none;animation:var(--tt-key) 1s var(--tt-ease) 1 calc(-1s * var(--tt-bind) / var(--tt-max)) both paused}"),d};window.typetura={classes:["typetura"],base:20,scale:1},function(){var a=0<arguments.length&&arguments[0]!==void 0?arguments[0]:{},b=a.classes,c=void 0===b?["typetura"]:b,f=a.base,g=void 0===f?20:f,h=a.scale,i=void 0===h?1:h;return new Promise(function(a){// Loop through new elements and attach resize observations.
